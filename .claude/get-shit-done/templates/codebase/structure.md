...
- Usage: Reference from command with `@/Users/pauvelascogarrofe/Documents/base-monorepo-template/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/pauvelascogarrofe/Documents/base-monorepo-template/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/pauvelascogarrofe/Documents/base-monorepo-template/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
