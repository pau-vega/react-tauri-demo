...
<!-- For checkpoint task examples and patterns, see @/Users/pauvelascogarrofe/Documents/base-monorepo-template/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/pauvelascogarrofe/Documents/base-monorepo-template/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/pauvelascogarrofe/Documents/base-monorepo-template/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/pauvelascogarrofe/Documents/base-monorepo-template/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
