...
- **Global scope**: `/Users/pauvelascogarrofe/Documents/base-monorepo-template/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/pauvelascogarrofe/Documents/base-monorepo-template/.claude/notes/`)
...
2. Glob `/Users/pauvelascogarrofe/Documents/base-monorepo-template/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/pauvelascogarrofe/Documents/base-monorepo-template/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/pauvelascogarrofe/Documents/base-monorepo-template/.claude/notes/` — works in any directory
