...
```bash
AUDITOR_MODEL=$(node "/Users/pauvelascogarrofe/Documents/base-monorepo-template/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/pauvelascogarrofe/Documents/base-monorepo-template/.claude/agents/gsd-eval-auditor.md for instructions.
